...
const ReportPage = () => {
  ...
  const reportCategories: ReportCategory[] = [
    ...
    },
    {
      ...
      icon: '💰',
      children: [
        { id: 'BillingFinance-Invoices', label: 'Invoices', icon: '📄' },
        { id: 'BillingFinance-Payments', label: 'Payments', icon: '💳' },
        { id: 'BillingFinance-Revenue', label: 'Revenue', icon: '📈' },
        { id: 'BillingFinance-Outstanding', label: 'Outstanding', icon: '⏰' },
      ],
    },
    {
      ...
      icon: '📝',
      children: [
        { id: 'ContractAgreement-Contracts', label: 'Contracts', icon: '📋' },
        { id: 'ContractAgreement-Agreements', label: 'Agreements', icon: '📄' },
        { id: 'ContractAgreement-Renewals', label: 'Renewals', icon: '🔄' },
      ],
    },
    {
      ...
      icon: '🚚',
      children: [
        { id: 'OperationsLogistics-Fleet', label: 'Fleet', icon: '🚛' },
        { id: 'OperationsLogistics-Routes', label: 'Routes', icon: '🗺️' },
        { id: 'OperationsLogistics-Collection', label: 'Collection', icon: '📦' },
        { id: 'OperationsLogistics-Barcode', label: 'Barcode', icon: '📊' },
      ],
    },
    {
      id: 'MasterData',
      ...
      icon: '📋',
      children: [
        { id: 'MasterData-Company', label: 'Company', icon: '🏢' },
        { id: 'MasterData-HCF', label: 'HCF', icon: '🏥' },
        { id: 'MasterData-User', label: 'User', icon: '👤' },
        { id: 'MasterData-Fleet', label: 'Fleet', icon: '🚗' },
      ],
    },
    {
      ...
      icon: '✅',
      children: [
        { id: 'ComplianceTraining-Certificates', label: 'Certificates', icon: '🎓' },
        { id: 'ComplianceTraining-Compliance', label: 'Compliance', icon: '✔️' },
      ],
    },
  ];
      ...
      <div className="reports-page">
        ...
        <div className="reports-content-wrapper">
          ...
          <div className="category-popover-wrapper" ref={categoryPopoverRef}>
            ...
            >
              <span className="category-icon">{reportCategories.find(c => c.id === selectedCategory)?.icon || '📊'}</span>
