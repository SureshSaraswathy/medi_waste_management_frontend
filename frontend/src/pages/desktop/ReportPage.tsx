      ...
      <div className="reports-page">
        ...
        <div className="reports-content-wrapper">
          ...
          <div className="reports-title-section">
            <div className="master-header reports-master-header">
              <div className="master-header-icon" aria-hidden="true">
              ...
              <div className="master-title-section">
                ...
                <p className="master-subtitle">Generate and view system reports</p>
              </div>
            </div>
          </div>
