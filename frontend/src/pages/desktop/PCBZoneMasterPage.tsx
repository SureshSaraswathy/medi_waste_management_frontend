  ...
  const handleDelete = async (id: string) => {
    if (window.confirm('Are you sure you want to delete this PCB Zone?')) {
      try {
        ...
        const { validatePcbZoneDelete } = await import('../../utils/deleteValidationService');
        const validation = await validatePcbZoneDelete(id);
        ...
        toast.success('PCB Zone deleted successfully');
      } catch (err) {
