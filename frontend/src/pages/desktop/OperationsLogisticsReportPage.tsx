...
const OperationsLogisticsReportPage = () => {
  ...
  const reportItems = [
    {
      id: 'route-trip-sheet',
      title: 'Route Trip Sheet / Trip Manifest',
      description: 'View route trip sheets and trip manifests',
      icon: (
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path>
          <polyline points="14 2 14 8 20 8"></polyline>
    ...
    {
      id: 'waste-collection-transactions',
      title: 'Waste Collection Transactions',
      description: 'Track waste collection transaction details',
      icon: (
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path>
          <polyline points="14 2 14 8 20 8"></polyline>
    ...
    },
    {
      ...
      description: 'View reports of missed waste collections',
      icon: (
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path>
          <polyline points="14 2 14 8 20 8"></polyline>
      ...
      path: '/report/operations-logistics/missed-collection',
    },
    {
        ...
        <div className="master-page">
          <div className="master-header">
            <div className="master-title-section">
              <h1 className="master-title">Operations & Logistics</h1>
              <p className="master-subtitle">Manage your operations and logistics reports</p>
            </div>
          </div>
...
export default OperationsLogisticsReportPage;
