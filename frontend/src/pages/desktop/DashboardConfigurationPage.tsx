...
const DashboardConfigurationPage: React.FC = () => {
  ...
  // Navigation items - same as DashboardPage
  const navItems = [
    { 
      path: '/dashboard', 
      label: 'Dashboard', 
  ...
  return (
    <div className="dashboard-page">
      {/* Left Sidebar - Same as DashboardPage */}
      ...
      <main className="dashboard-main">
        ...
        <header className="dashboard-header">
          <div className="header-left">
            <span className="breadcrumb">MEDI-WASTE / Dashboard Configuration</span>
          </div>
        </header>

        {/* Dashboard Configuration Content */}
        <div className="dashboard-configuration-content" style={{ padding: 0, overflow: 'hidden', flex: 1 }}>
